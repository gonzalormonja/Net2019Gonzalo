...
namespace Lab02
{
    public class ManejadorArchivoTxt:ManejadorArchivo
    {
        protected string connectionString
        {
            get
            {
                return @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Users\Nicolás\Net2019\Unidad 4\Lab02\Lab02\Lab02\bin\Debug;" +
        ...
        public override DataTable getTabla()
        {
            ...
            {
                OleDbCommand cmdSelect = new OleDbConnection("select * from agenda.txt", Conn);
                Conn.Open();
